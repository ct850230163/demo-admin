package cn.vpclub.demo.admin.api.common.exception;
...
public class RRExceptionHandler {
	...
	public BaseResponse handleRRException(RRException e){
		...
		baseResponse.setReturnCode(e.getCode());
	...
	public BaseResponse handlerNoFoundException(Exception e) {
		...
		return new FailResponse("路径不存在，请检查路径是否正确");
	}
